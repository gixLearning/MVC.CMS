...
namespace MVC.CMS.Controllers {
    ...
    public class ManageController : Controller {
        ...
        public ActionResult DeleteUser(string id) {
            ...
            if (UserManager.IsInRole(id, RoleTypes.Admin)) {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest, "Cannot delete admin-type, contact overlord for further instructions on how to delete admins.");
            }
        ...
        [Authorize(Roles = RoleTypes.Admin)]
        [HttpPost]
        public ActionResult DeleteUser(UserList user) {
            if (user == null) {
                return HttpNotFound();
            }

            try {
                var userToDelete = UserManager.FindById(user.UserId);
                ...
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest, "User could not be deleted.");
            }
